...
class Command
{
    ...
    void menuScreen()
    {
        System.out.println("\nWelcome to the Referee Scheduling System\n");
        System.out.println("This system has been designed by Harris Rasheed " +
        ...
        try
        {
            ...
            while(notQuit)
            {
                ...
                switch(command)
                {
                    ...
                    case -2:
                    System.err.println("Ambiguous command input. Please type a unique command prefix");
    ...
    /**
     * Compares two characters and returns whether they are equal regardless of case
     * (an equivalent of equalsIgnoreCase method for strings but for characters).
