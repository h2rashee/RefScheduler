...
class Time
{
    ...
    /**
     * Ensures that the time information read and interpreted in the Time object is appropriate and valid.
     */
    void validateTime()
    {
        if(hour < 0 || hour > 23)
    ...
    int getDay()
    {
        ...
        {
            System.err.println("Invalid day provided in the date. Given day: " + day);
            System.exit(1);
            return -1;
        }
    }
    ...
    int getMonth(String month)
    {
        ...
        {
            System.err.println("Invalid month provided in the date. Given month: " + month);
            System.exit(1);
            return -1;
        }
    }
